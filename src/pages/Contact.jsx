            ...
            <div className="bg-primary flex flex-col gap-6 justify-between rounded-3xl px-9 py-10 lg:col-span-2">
              ...
              <div className="flex flex-col items-start gap-y-10 text-softWhite">
                ...
                <div className='flex items-start gap-4'>
                  ...
                  <Link className='font-normal text-base' to=''>132 Dartmouth Street Boston, MA 02156</Link> 
                </div>
              </div>
            ...
            <div className='lg:col-span-3'>
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <label className="text-[#404040] text-base font-normal">First Name</label>
                        <input
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                    ...
                    <div>
                        ...
                        <input
                            type="phone" {...register("phone", { required: "Phone number is required" })}
                            className="w-full px-0 py-1 border-b-2 focus:outline-none bg-transparent"
                ...
                <div className="mt-8">
                    ...
                    {errors?.message && <p className="text-red-500 text-xs mt-1">{errors?.subject?.message}</p>}
                </div>
